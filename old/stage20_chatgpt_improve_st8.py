"""
Stage 8 — Attribute Table
What's new

Right-click a layer in Active Layers:

Attribute Table

You get a searchable, sortable, read-only table containing the layer's attributes.
...
Double-click a row → select and zoom to that feature
Selected feature is highlighted on the map
Works with the existing large-layer architecture
"""
