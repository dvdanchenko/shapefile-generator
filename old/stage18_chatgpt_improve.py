...
Each loaded layer now gets a background geometry QC check.
...
Null geometries
Empty geometries
Zero-length LineStrings / MultiLineStrings
Duplicate geometries
Geometry-type breakdown
Missing CRS warning

The QC runs in the background, so the large-file loading/rendering architecture isn't replaced by expensive synchronous QC.
"""
